...
export FASTQR_INCLUDE_TVCQR_PPRO="${FASTQR_INCLUDE_TVCQR_PPRO:-0}"
export FASTQR_INCLUDE_TVCQR_SEQ_R="${FASTQR_INCLUDE_TVCQR_SEQ_R:-1}"
export FASTQR_INCLUDE_TVCQR_SEQ_PPRO_R="${FASTQR_INCLUDE_TVCQR_SEQ_PPRO_R:-1}"
export FASTQR_INCLUDE_TVCQR_PPRO_FORTRAN="${FASTQR_INCLUDE_TVCQR_PPRO_FORTRAN:-1}"
...
export FASTQR_INCLUDE_TVCQR_PPRO="${FASTQR_INCLUDE_TVCQR_PPRO}"
export FASTQR_INCLUDE_TVCQR_SEQ_R="${FASTQR_INCLUDE_TVCQR_SEQ_R}"
export FASTQR_INCLUDE_TVCQR_SEQ_PPRO_R="${FASTQR_INCLUDE_TVCQR_SEQ_PPRO_R}"
export FASTQR_INCLUDE_TVCQR_PPRO_FORTRAN="${FASTQR_INCLUDE_TVCQR_PPRO_FORTRAN}"
